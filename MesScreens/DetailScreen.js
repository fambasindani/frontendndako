...
const styles = StyleSheet.create({
  ...
  imageContainer: { position: "relative",borderColor:"#234270",borderBottomWidth:0.2,marginBottom:1 },
  image: { width: width, height: 250, resizeMode: "cover",},
  noImage: { alignItems: "center", justifyContent: "center", backgroundColor: "#f0f0f0", },
  shareButton: {alignItems: "center", justifyContent: "center", position: "absolute", top: 15, right: 15,width:45, height:45, backgroundColor: "#234270",  borderRadius: 8 },
  ...
  details: { padding: 5, },
  title: { fontSize: 22, fontWeight: "bold", marginBottom: 5, color:"#234270"},
  ...
  status: { paddingVertical: 6, paddingHorizontal: 12, borderRadius: 3, fontSize: 13, borderWidth: 0.5, overflow: "hidden", marginLeft: 3 },
  sectionTitle: { fontSize: 18, fontWeight: "bold", marginVertical: 10,  color:"#234270", margin:5 },
